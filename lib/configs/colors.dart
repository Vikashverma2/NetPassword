...
const primaryColor = Color(0xff065FEF);
const backgroundColor = Color(0xffF2F3F7);
const primaryContainerColor = Color(0xffFFFFFF);
const onBackgroundColor = Color(0xff202228);
const onPrimaryContainerColor = Color(0xff8C8C8C);
const lightBlueColor = Color(0xffD8E7FF);
